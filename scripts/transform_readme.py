...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/sparv-sbx-whisper-import.svg",
            f"https://img.shields.io/pypi/v/sparv-sbx-whisper-import/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/sparv-sbx-whisper-import.svg",
            f"https://img.shields.io/pypi/l/sparv-sbx-whisper-import/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/sparv-sbx-whisper-import.svg",
            f"https://img.shields.io/pypi/pyversions/sparv-sbx-whisper-import/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/sparv-sbx-whisper-import.svg",
            f"https://img.shields.io/pypi/status/sparv-sbx-whisper-import/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/sparv-sbx-whisper-import/blob/v{version}/README.md",
                url,
            )
        return f"]({url})"
