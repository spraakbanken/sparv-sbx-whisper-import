...
def test_example_hello_whisper(setup_sparv: None, snapshot: SnapshotAssertion) -> None:  # noqa: ARG001
    base_dir = Path("examples/hello-whisper")
    ...
    args = ["--dir", "examples/hello-whisper", "run", "xml_export:pretty", "--log", "--cores", "1"]
