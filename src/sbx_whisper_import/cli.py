...
def _run_transcription(argv: t.Sequence[str] | None = None) -> TranscribeResult:
    ...
    importer = HFWhisperImporter(model_size=args.model_size, model_verbosity=args.verbosity, verbose=not args.quiet, temperature=args.temperature)
...
def _build_cli() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--temperature", type=float, default=0, help="set temperature controlling randomness, values between 0 and 1, defaults to 0")
    parser.add_argument(
